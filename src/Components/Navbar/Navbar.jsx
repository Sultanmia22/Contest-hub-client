...
const Navbar = () => {
    ...
    const links = <>
        ...
        <li><NavLink>All Contest</NavLink></li>
                        ...
                        user ?
                            <div className='pr-4 md:pr-0'>
                                ...
                                <ul className="dropdown menu rounded-box bg-secondary shadow-sm flex flex-col gap-2 md:px-5 md:py-7"
                                    popover="auto" id="popover-1" style={{
                                        positionAnchor: "--anchor-1", insetInlineStart: "auto",
                                        insetInlineEnd: "0"
                                    ...
                                    <button onClick={handleSignOut} className='btn btn-sm max-w-[100px] text-white btn-primary'>Sign Out</button>
                                </ul>
                            </div>
