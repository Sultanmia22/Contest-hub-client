            ...
            <div className='max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4'>
                ...
                <div className='flex items-center gap-3'>
                            ...
                            {open && (
                                <div className='absolute right-0 top-[calc(100%+10px)] w-64 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-lg shadow-slate-900/10 dark:shadow-black/30 overflow-hidden z-50 animate-in fade-in slide-in-from-top-1 duration-150'>
                                    ...
                                    <div className='p-1.5'>
                                        ...
                                        {/* Mobile theme toggle */}
                                        <div className='lg:hidden flex items-center gap-2.5 w-full px-3 py-2'>
                                            <label className='swap swap-rotate cursor-pointer'>
                                                <input onChange={(e) => handleTheme(e.target.checked)} type='checkbox' className='theme-controller' value='synthwave' />
                                                <svg className='swap-off h-4 w-4 fill-current text-slate-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
                                                    <path d='M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z' />
                                                </svg>
                                                <svg className='swap-on h-4 w-4 fill-current text-slate-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
                                                    <path d='M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z' />
                                                </svg>
                                            </label>
                                            <span className='text-[13px] text-slate-500 dark:text-slate-400 font-medium'>Toggle theme</span>
                                        </div>
                    ...
                    <div className='dropdown lg:hidden'>
                        <div tabIndex={0} role='button' className='btn btn-ghost btn-sm text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'>
                            <svg xmlns='http://www.w3.org/2000/svg' className='h-5 w-5' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                                <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M4 6h16M4 12h8m-8 6h16' />
                            </svg>
                        </div>
                        <ul tabIndex='-1' className='dropdown-content mt-2 w-52 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-lg p-2 z-50 space-y-0.5 list-none'>
                            {links}
                            {!user && (
                                <li className='pt-2 border-t border-slate-100 dark:border-slate-700 mt-1 flex gap-2'>
                                    <Link to='login' className='flex-1 text-center px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600 rounded-lg hover:border-secondary/40 hover:text-secondary transition-colors'>Login</Link>
                                    <Link to='register' className='flex-1 text-center px-3 py-1.5 text-xs font-semibold text-white bg-secondary rounded-lg hover:bg-indigo-600 transition-colors'>Sign Up</Link>
                                </li>
                            )}
                        </ul>
                    </div>
